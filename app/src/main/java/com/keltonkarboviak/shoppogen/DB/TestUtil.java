...
public class TestUtil
{
    public static void insertFakeData(SQLiteDatabase db)
    {
        ...
        cv.put(ShoppoContract.CouponProductEntry.COLUMN_PRODUCT_ID, "apple");
        list.add(cv);

        cv = new ContentValues();
        cv.put(ShoppoContract.CouponProductEntry.COLUMN_COUPON_ID, 0);
        cv.put(ShoppoContract.CouponProductEntry.COLUMN_PRODUCT_ID, "banana");
        list.add(cv);
        ...
        cv = new ContentValues();
        cv.put(ShoppoContract.CouponProductEntry.COLUMN_COUPON_ID, 1);
        cv.put(ShoppoContract.CouponProductEntry.COLUMN_PRODUCT_ID, "pepsi");
        list.add(cv);
        ...
        cv = new ContentValues();
        cv.put(ShoppoContract.CouponProductEntry.COLUMN_COUPON_ID, 2);
        cv.put(ShoppoContract.CouponProductEntry.COLUMN_PRODUCT_ID, "pear");
        list.add(cv);

        cv = new ContentValues();
        cv.put(ShoppoContract.CouponProductEntry.COLUMN_COUPON_ID, 2);
        cv.put(ShoppoContract.CouponProductEntry.COLUMN_PRODUCT_ID, "grapes");
        list.add(cv);
